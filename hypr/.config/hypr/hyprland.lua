...
-- 1. Application and Toggles
hl.bind(mainMod .. " + Q", hl.dsp.exec_cmd(terminal), { description = "Terminal" })
local closeWindowBind = hl.bind(mainMod .. " + C", hl.dsp.window.close(), { description = "Close the Window" })
-- closeWindowBind:set_enabled(false)
hl.bind(mainMod .. " + M",
    hl.dsp.exec_cmd("command -v hyprshutdown >/dev/null 2>&1 && hyprshutdown || hyprctl dispatch exit"),
    { description = "Exit Hyprland / Power Menu" })
...
-- Custom Keybinds
-- 2. Custom Keybinds
hl.bind(mainMod .. " + SHIFT + G", hl.dsp.exec_cmd("qs -c noctalia-shell ipc call plugin:screen-recorder toggle"),
    { description = "Toggle Screen Record (Full)" })
hl.bind(mainMod .. " + L", hl.dsp.exec_cmd("qs -c noctalia-shell ipc call lockScreen lock"),
    { description = "Lock Screen" })
hl.bind(mainMod .. " + SHIFT + T", hl.dsp.exec_cmd("qs -c noctalia-shell ipc call darkMode toggle"),
    { description = "Toggle Dark/Light Mode" })
hl.bind(mainMod .. " + F10", hl.dsp.exec_cmd("qs -c noctalia-shell ipc call controlCenter toggle"),
    { description = "Toggle Control Center" })
hl.bind(mainMod .. " + F11", hl.dsp.exec_cmd("qs -c noctalia-shell ipc call sessionMenu toggle"),
    { description = "Toggle Session Menu" })
hl.bind(mainMod .. " + F12", hl.dsp.exec_cmd("qs -c noctalia-shell ipc call plugin:keybind-cheatsheet toggle"),
    { description = "Toggle Keybind Cheatsheet" })
hl.bind("PRINT", hl.dsp.exec_cmd([[grimblast --freeze copy area]]),
    { description = "Freeze Screenshot (Select to Clipboard)" })
hl.bind(mainMod .. " + PRINT", hl.dsp.exec_cmd([[grim -g "$(slurp)" - | wl-copy]]),
    { description = "Quick Screenshot (Select to Clipboard)" })
